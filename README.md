...
The data is currently too slow for this to be really useful becuase I'm using the free tier of Finnhub so I only get an updated price every 60 seconds. Everything is theoretically in place to handle a paid API but I need the free time so this is what it is for now. I'll probably go with another provider at this point.
